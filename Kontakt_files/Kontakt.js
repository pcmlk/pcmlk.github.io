...
function onPageLoad()
{
    ...
    fixupIEPNG("id1", "Kontakt_files/transparent.gif");
    fixupIEPNG("id6", "Kontakt_files/transparent.gif");
    fixupIEPNG("id9", "Kontakt_files/transparent.gif");
    fixupIEPNG("id12", "Kontakt_files/transparent.gif");
    fixupIEPNG("id15", "Kontakt_files/transparent.gif");
    return true;
}
