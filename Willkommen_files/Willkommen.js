IMpreload('Willkommen_files', 'shapeimage_5', '0');
var MINIMUM_FONT = "10";
var UNITS = "";
...
function onPageLoad()
{
    ...
    fixupIEPNG("id6", "Willkommen_files/transparent.gif");
    fixupIEPNG("id7", "Willkommen_files/transparent.gif");
    fixupIEPNG("id8", "Willkommen_files/transparent.gif");
    fixupIEPNG("id12", "Willkommen_files/transparent.gif");
    fixupIEPNG("shapeimage_5_link_0", "Willkommen_files/transparent.gif");
    fixupIEPNG("shapeimage_5", "Willkommen_files/transparent.gif");
    fixupIEPNG("id15", "Willkommen_files/transparent.gif");
    fixupIEPNG("id17", "Willkommen_files/transparent.gif");
    return true;
}
