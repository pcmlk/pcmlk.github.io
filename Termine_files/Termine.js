...
function onPageLoad()
{
    ...
    fixupIEPNG("id1", "Termine_files/transparent.gif");
    fixupIEPNG("id6", "Termine_files/transparent.gif");
    fixupIEPNG("id9", "Termine_files/transparent.gif");
    fixupIEPNG("id11", "Termine_files/transparent.gif");
    fixupIEPNG("id12", "Termine_files/transparent.gif");
    return true;
}
