...
function onPageLoad()
{
    ...
    fixupIEPNG("id1", "files/transparent.gif");
    fixupIEPNG("id6", "files/transparent.gif");
    fixupIEPNG("id7", "files/transparent.gif");
    fixupIEPNG("id8", "files/transparent.gif");
    fixupIEPNG("id12", "files/transparent.gif");
    fixupIEPNG("shapeimage_5_link_0", "files/transparent.gif");
    fixupIEPNG("shapeimage_5", "files/transparent.gif");
    fixupIEPNG("id15", "files/transparent.gif");
    fixupIEPNG("id17", "files/transparent.gif");
    return true;
}
